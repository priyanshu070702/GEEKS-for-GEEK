<h2><a href="https://practice.geeksforgeeks.org/problems/square-root/1?utm_source=gfg&utm_medium=article&utm_campaign=bottom_sticky_on_article">Square root of a number</a></h2><h3>Difficulty Level : Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given an integer <strong>x,</strong>&nbsp;find the square root of x. If <strong>x</strong> is not a perfect square, then return floor(√x).</span></p>
